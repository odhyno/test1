...
public class RegisterGUI extends WindowManager {
	...
	private static String registError = "Registration Error";
    ...
    public void sendUsernameAlert() {
		...
		alert.setHeaderText(registError);
    ...
    @FXML
    public void checkBoxClick() { nameBandVisible(); }
